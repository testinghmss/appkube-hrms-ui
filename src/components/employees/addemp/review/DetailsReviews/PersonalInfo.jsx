...
const PersonalInfo = ({Perdata}) => {

  
  console.log(Perdata.personal_information, 'persdata from personal')
...
<div className="grid grid-cols-2 grid-rows-9">
  {Perdata?.personal_information && Object.keys(Perdata.personal_information).length > 0 && (
    <>
      <span className="mb-4">
        <h2 className="text-gray-400">First Name</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.first_name}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Last Name</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.last_name}</p>
      </span>

      {/* second row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Date of Birth</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.dob}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Gender</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.gender}</p>
      </span>

      {/* third row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Contact No.</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.number}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Emergency Contact No.</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.emergency_number}</p>
      </span>

      {/* fourth row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Work Email</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.work_email}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Personal Email</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.email}</p>
      </span>

      {/* fifth row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Employee ID</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.id}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Qualification</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.highest_qualification}</p>
      </span>

      {/* sixth row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Address Line 1</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.address_line_1}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Address Line 2</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.address_line_2}</p>
      </span>

      {/* seventh row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Landmark</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.landmark}</p>
      </span>
      <span>
        <h2 className="text-gray-400">City</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.city}</p>
      </span>

      {/* eighth row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">State</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.state}</p>
      </span>
      <span>
        <h2 className="text-gray-400">Country</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.country}</p>
      </span>

      {/* ninth row  */}
      <span className="mb-4">
        <h2 className="text-gray-400">Zip code</h2>
        <p className="font-semibold text-base">{Perdata.personal_information.zipcode}</p>
      </span>
    </>
  )}
</div>
