...
//   const selectedDepartment = useSelector((state) => state.profDetails.selectedDepartment);
//   const selectedDesignation = useSelector((state) => state.profDetails.selectedDesignation);
//   const selectedReportingMngr = useSelector((state) => state.profDetails.selectedReportingMngr);
//   const selectedworkLocation = useSelector((state) => state.profDetails.selectedworkLocation);
//   const selectedDate = useSelector((state) => state.profDetails.selectedDate);
